...
public class PowerOpsGraphConfig {
    ...
    public PowerOpsGraphConfig(LlmFactory llmFactory) {
    ...
    public StateGraph powerOpsGraph(
        ...
        ChatAgentNode chatAgentNode = new ChatAgentNode(llmFactory, tools, hybridSearchService);
        ...
        StateGraph graph = new StateGraph("power_ops_workflow", stateFactory)
                ...
                .addNode("tool_execute", node_async(observed("tool_execute",
                        new ToolExecuteNode(toolAgent), observabilityService, checkpointService)))
                ...
                .addNode("react_qa_agent", node_async(observed("react_qa_agent",
                        new ReactQaAgentNode(llmFactory, tools, knowledgeGraphService), observabilityService, checkpointService)))
