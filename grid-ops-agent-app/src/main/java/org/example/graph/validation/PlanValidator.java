...
public class PlanValidator {
    ...
    private void normalizeStep(PlanStep step, int index, Set<String> availableTools, List<String> warnings) {
        ...
        String toolName = step.effectiveToolName();
        if ("slot_filler".equals(toolName)) {
            step.setStepType("ANALYSIS");
            step.setToolName(null);
            step.setTool(null);
        ...
        String mappedNariTool = KnowledgeOrganizationService.mapToolName(toolName);
        if (mappedNariTool != null && !mappedNariTool.equals(toolName)) {
